      ...
      <BrowserRouter>
        <UsuarioContext.Provider value={{
          ...
          <Nav fill variant="tabs" defaultActiveKey="/imc-toma">
            ...
            <Nav.Item>
              <Link to="/forms/basic" className="nav-link" data-rb-event-key="link-1" role="button">Formulario 1</Link>
            </Nav.Item>
            <Nav.Item>
              <Link to="/forms/basicyup" className="nav-link" data-rb-event-key="link-1" role="button">Formulario 2</Link>
            </Nav.Item>
          </Nav>
          ...
          <Switch>
            ...
            <Route path="/imc-paciente/:id" exact render={(props) => <PatientApp {...props} />} />
            <Route path="/imc-estadistica" exact children={(props) => {
              console.log(props)
              return <ViewAppImc />
            }} />
          </Switch>
